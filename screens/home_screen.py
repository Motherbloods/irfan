...
class homeScreen(Screen):
    ...
    def build_ui(self, dt):
        ...
        logoTebakGambar = Image(source='assets/img/logo.png', size_hint=(None, None), size=(500, 500),
        ...
        keluarBTn = ClickableImage(size_hint=(None, None), size=(150, 150),
        ...
        try:
            self.settings_button = ClickableImage(source='assets/gif/setting.gif', size_hint=(None, None), size=(100, 100),
