...
class TebakGambarGame(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        back_button = Button(size_hint=(None, None), size=(140, 100),
                            pos_hint={'center_x': 0.5, 'top': 1.02},
                            background_normal='assets/img/back.png',  
                            ) 
        ...
        self.hint_button = Button(background_normal=f"assets/img/nyawa-bantuan/bantuan_{self.hints_left}.png", size_hint=(None, None), size=(140, 170),
        ...
        self.tree_image = Button(size_hint=(0.4, 0.2), pos_hint={'center_x': 0.5, 'center_y': 0.7},
                               background_normal='assets/img/speakerOn.png')
    ...
    def show_game_over_popup(self):
        """Menampilkan popup Game Over dan tombol untuk kembali ke menu sebelumnya."""
        game_over_popup_content = BoxLayout(orientation='vertical')
        game_over_message = Label(text="Game Over! Kamu telah kehabisan nyawa.", font_size=20)
        game_over_popup_content.add_widget(game_over_message)

        back_button = Button(text="Kembali", size_hint=(None, None), size=(100, 50), pos_hint={'center_x': 0.5})
        back_button.bind(on_press=self.go_back_from_game_over)

        game_over_popup_content.add_widget(back_button)

        self.game_over_popup = Popup(title="Game Over", content=game_over_popup_content, size_hint=(0.8, 0.4))
    ...
    def show_complete_answer_popup(self, stars=0, correct_answer=False):
        ...
        if correct_answer:
            ...
            back_button = Button(size_hint=(None, None), size=(120, 120), background_normal='assets/img/popup/home.png')
            back_button.bind(on_press=self.go_back_and_close_popup)
            back_button.pos_hint = {'x': 0.12, 'center_y': 0.3}  
            button_layout.add_widget(back_button)

            if stars > 0:
                next_button = Button(size_hint=(None, None), size=(120, 120), background_normal='assets/img/popup/next.png')
                next_button.bind(on_press=self.go_to_next_level)
                next_button.pos_hint = {'right': 0.88, 'center_y': 0.3} 
                button_layout.add_widget(next_button)
            else : 
                close_button = Button(size_hint=(None, None), size=(120, 120), background_normal='assets/img/popup/ulang.png')
    ...
    def show_complete_popup(self):
        ...
        home_button = Button(size_hint=(None, None), size=(100, 100), 
                            background_normal='assets/img/popup/home.png', pos_hint={'center_x': 0.5, 'top':1})
    ...
    def show_bantuan_popup(self, show_image=False):
        ...
        close_button = Button(size_hint=(None, None), size=(120, 120), 
                            background_normal='assets/img/x.png', pos_hint={'right': 0.98, 'top': 0.88})
